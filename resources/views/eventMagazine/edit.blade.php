        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{ route('event.magazine.update', $event->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <img src="{{ asset('assets/images/banners/' . $event->image_banner) }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_title" placeholder="Meta title"
                                            ...
                                            id="meta_title" value="{{$event->meta_title}} ">
                                        @error('meta_title')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_keywords"
                                            ...
                                            id="meta_keywords" value="{{$event->meta_keywords}}">
                                        @error('meta_keywords')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_description"
                                            ...
                                            id="meta_description" value="{{$event->meta_description}}">
