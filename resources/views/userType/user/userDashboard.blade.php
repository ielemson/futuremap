				...
				@endphp
			        ...
			        <div class="customer-area">
						...
						<div class="col-12 col-sm-8 col-md-6 col-lg-4">
							<div class="card">
							  <img class="card-img-top" src="{{asset('assets/images/products')}}/{{$order->product->image}}" alt="Magazine" style="width:aut0">
							  <div class="card-body">
								<h4 class="card-title">{{$order->product->name}}</h4>
								<a href="{{asset('assets/magazine/uploads')}}/{{$order->product->file}}" class="text-medium btn btn-success btn-block mx-auto">Download Magazine</a>
							  </div>
							</div>
						  </div>
						@endforeach
