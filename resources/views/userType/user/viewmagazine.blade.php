            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <ol class="breadcrumb mb-4">
                       ...
                       <div class="row">
                        <div class="col-lg-12 col-md-12 text-center embed-responsive-item">
                            {{-- <iframe class="embed-responsive-item" src="{{ asset('assets/magazine/uploads') }}/{{ $pdf->file }}" allowfullscreen></iframe> --}}
                            <embed src="/assets/magazine/uploads/{{$pdf->file }}" style="width: 100%; height:500px" alt="pdf" />
                          </div>
                       </div>
                    </div>
                </main>
