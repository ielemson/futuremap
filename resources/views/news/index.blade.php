                    ...
                    @if (count($news) > 0)
                        ...
                        <div class="col-12 list-item">
                            <div class="card d-flex flex-row mb-3">
                                <a class="d-flex card-img newsViewTab" data-id="{{$newslist->id}}" href="#editLayoutItem" data-toggle="modal" data-target="#editLayoutItem">
                                    <img src="{{asset('assets/images/news')}}/{{$newslist->image}}" alt="Donec sit amet est at sem iaculis aliquam." class="list-thumbnail responsive border-0">
                                    {{-- <span class="badge badge-pill badge-primary position-absolute badge-top-left">{{ __('New')}}</span> --}}
                                    <span class="badge badge-pill badge-secondary position-absolute badge-top-left-2">{{$newslist->category->name}}</span>
                                </a>
                                <div class="d-flex flex-grow-1 min-width-zero card-content">
                                    <div class="card-body align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                                        <a class="list-item-heading mb-1 truncate w-40 w-xs-100 newsViewTab" data-id="{{$newslist->id}}" href="#editLayoutItem" data-toggle="modal" data-target="#editLayoutItem">
                                             {!! substr($newslist->details, 0, 100) !!}
                                        </a>
                                        <p class="mb-1 text-muted text-small category w-15 w-xs-100">{{$newslist->title}}</p>
                                    ...
                                    <div class="list-actions">
                                        <a href="#editLayoutItem" data-toggle="modal" data-target="#editLayoutItem"><i class="ik ik-eye newsViewTab" data-id="{{$newslist->id}}"></i></a>
                                        <a href="{{route('news.edit',$newslist->id)}}"><i class="ik ik-edit-2"></i></a>
                                        <a href="#" class="list-delete" data-id="{{$newslist->id}}"><i class="ik ik-trash-2"></i></a>
                                    </div>
            ...
            $(document).ready(function() {
                $(".newsViewTab").on("click", function() {
                    ...
                    //  console.log(data.news.title)
                            ...
                            $(".news-image").html(`<img src="/assets/images/news/${data.news.image}" class="img-fluid" alt="">`)
